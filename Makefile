# Makefile for KOE Syndicate A2A Project
# 
# Usage:
...
help:
	@echo "KOE Syndicate A2A Project - Available Commands:"
	@echo ""
...
.env.example:
	@echo "# KOE Syndicate A2A Project Environment Variables" > .env.example
