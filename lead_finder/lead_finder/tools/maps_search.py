...
class GoogleMapsClient:
    ...
    def search_businesses(
        ...
        max_results: int = 10,  # Reduced to 10 to avoid Gemini rate limits
...
def google_maps_search(
    ...
    business_type: Optional[str] = None,
    min_rating: float = 0.0,
    max_results: int = 10,  # Changed to 10 to avoid Gemini rate limits for the hackathon demo
    exclude_websites: bool = False
) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        exclude_websites: If True, only return businesses without websites (default: False)
