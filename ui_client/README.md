# 🖥️ UI Client - Koe Syndicate Dashboard
...
The UI Client serves as the central orchestration point for the Koe Syndicate platform:
...
```bash
docker build -f Dockerfile.ui_client -t koesyndicate-ui-client .
```
