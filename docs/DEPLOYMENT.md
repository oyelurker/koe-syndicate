...
The Koe Syndicate application now uses Gmail service account authentication for automated email sending. This eliminates the need for manual OAuth authentication and makes the system fully automated.
...
import sys
import os
sys.path.append('/Users/xskills/Development/Python/Hackathons/Koe Syndicate')
os.chdir('/Users/xskills/Development/Python/Hackathons/Koe Syndicate/sdr/sdr/sub_a
gents/outreach_email_agent/tools')
from create_pdf_offer import create_sales_proposal_pdf
sys.path.append('/Users/xskills/Development/Python/Hackathons/Koe Syndicate/sdr/sd
